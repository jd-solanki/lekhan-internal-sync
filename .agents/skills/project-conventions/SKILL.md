...
- **[Utilities Conventions](references/utilities.md)** - Generic utility organization and placement
- **[Frontend Conventions](references/frontend.md)** - Type safety, reactive state management, UI patterns, and page component decomposition
